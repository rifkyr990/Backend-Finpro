...
class StockService {
  public static getAllProductStocks = async () => {
  ...
  public static changeProductStock = async (
    storeId: number,
  ...
  public static getAllStockHistory = async () => {
  ...
  public static getStockHistoryWithSummary = async (
